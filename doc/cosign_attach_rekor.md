...
Attach rekor bundles to the supplied container image

```
cosign attach rekor [flags]
```

### Examples

```
  cosign attach rekor <image uri>
```
...
```
  ...
  -h, --help                                                                                     help for rekor
      ...
      --rekor-url string                                                                         path to the rekor-url, or {-} for stdin
