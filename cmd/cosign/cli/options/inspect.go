...
type CommonInspectOptions struct {
	Offline          bool // Force offline verification
	TSACertChainPath string
	IgnoreTlog       bool
}

func (o *CommonInspectOptions) AddFlags(cmd *cobra.Command) {
	cmd.Flags().BoolVar(&o.Offline, "offline", false,
		"only allow offline inspection")

	cmd.Flags().BoolVar(&o.IgnoreTlog, "insecure-ignore-tlog", false,
		"ignore transparency log, to be used when an artifact signature has not been uploaded to the transparency log. Artifacts "+
...
func (o *InspectOptions) AddFlags(cmd *cobra.Command) {
	...
	o.CommonInspectOptions.AddFlags(cmd)
...
// InspectAttestationOptions is the top level wrapper for the `inspect-attestation` command.
type InspectAttestationOptions struct {
	// Key         string
	// CheckClaims bool
	Output string

	CommonInspectOptions CommonInspectOptions
	SecurityKey          SecurityKeyOptions
	Rekor                RekorOptions
	CertVerify           CertVerifyOptions
	Registry             RegistryOptions
...
// AddFlags implements Interface
func (o *InspectAttestationOptions) AddFlags(cmd *cobra.Command) {
	o.SecurityKey.AddFlags(cmd)
	o.Rekor.AddFlags(cmd)
	o.CertVerify.AddFlags(cmd)
	o.Registry.AddFlags(cmd)
...
// InspectBlobOptions is the top level wrapper for the `verify blob` command.
...
// AddFlags implements Interface
func (o *InspectBlobOptions) AddFlags(cmd *cobra.Command) {
	o.Rekor.AddFlags(cmd)
...
// InspectBlobAttestationOptions is the top level wrapper for the `inspect-blob-attestation` command.
type InspectBlobAttestationOptions struct {
...
// AddFlags implements Interface
func (o *InspectBlobAttestationOptions) AddFlags(cmd *cobra.Command) {
