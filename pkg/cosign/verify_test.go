...
func TestValidateAndUnpackCertSuccess(t *testing.T) {
	...
	co := &CheckOpts{
		RootCerts:  rootPool,
		Identities: []Identity{Identity{Subject: subject, Issuer: oidcIssuer}},
	}
...
func TestValidateAndUnpackCertSuccessWithUriSan(t *testing.T) {
	...
	co := &CheckOpts{
		RootCerts:  rootPool,
		Identities: []Identity{Identity{Subject: "scheme://userinfo@host", Issuer: oidcIssuer}},
	}
...
func TestValidateAndUnpackCertInvalidOidcIssuer(t *testing.T) {
	...
	co := &CheckOpts{
		RootCerts:  rootPool,
		Identities: []Identity{Identity{Subject: subject, Issuer: "other"}},
	}
...
func TestValidateAndUnpackCertInvalidEmail(t *testing.T) {
	...
	co := &CheckOpts{
		RootCerts:  rootPool,
		Identities: []Identity{Identity{Subject: "other", Issuer: oidcIssuer}},
	}
