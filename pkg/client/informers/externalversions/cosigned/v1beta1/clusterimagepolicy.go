...
import (
	...
	v1beta1 "github.com/sigstore/cosign/pkg/client/listers/cosigned/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CosignedV1beta1().ClusterImagePolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CosignedV1beta1().ClusterImagePolicies().Watch(context.TODO(), options)
			},
		},
		&cosignedv1beta1.ClusterImagePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterImagePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cosignedv1beta1.ClusterImagePolicy{}, f.defaultInformer)
}
