...
import (
	...
	policycontrollerv1alpha1 "github.com/sigstore/cosign/pkg/apis/policycontroller/v1alpha1"
	...
	v1alpha1 "github.com/sigstore/cosign/pkg/client/listers/policycontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicycontrollerV1alpha1().ClusterImagePolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicycontrollerV1alpha1().ClusterImagePolicies().Watch(context.TODO(), options)
			},
		},
		&policycontrollerv1alpha1.ClusterImagePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterImagePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policycontrollerv1alpha1.ClusterImagePolicy{}, f.defaultInformer)
}
