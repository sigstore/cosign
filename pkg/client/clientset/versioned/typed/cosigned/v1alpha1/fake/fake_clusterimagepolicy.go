...
type FakeClusterImagePolicies struct {
	Fake *FakeCosignedV1alpha1
}

var clusterimagepoliciesResource = schema.GroupVersionResource{Group: "cosigned.sigstore.dev", Version: "v1alpha1", Resource: "clusterimagepolicies"}

var clusterimagepoliciesKind = schema.GroupVersionKind{Group: "cosigned.sigstore.dev", Version: "v1alpha1", Kind: "ClusterImagePolicy"}
