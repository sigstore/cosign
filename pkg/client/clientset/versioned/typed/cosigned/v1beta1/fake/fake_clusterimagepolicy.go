...
type FakeClusterImagePolicies struct {
	Fake *FakeCosignedV1beta1
}

var clusterimagepoliciesResource = schema.GroupVersionResource{Group: "cosigned.sigstore.dev", Version: "v1beta1", Resource: "clusterimagepolicies"}

var clusterimagepoliciesKind = schema.GroupVersionKind{Group: "cosigned.sigstore.dev", Version: "v1beta1", Kind: "ClusterImagePolicy"}
