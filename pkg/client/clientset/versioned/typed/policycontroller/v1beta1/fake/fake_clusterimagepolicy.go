...
type FakeClusterImagePolicies struct {
	Fake *FakePolicycontrollerV1beta1
}

var clusterimagepoliciesResource = schema.GroupVersionResource{Group: "policycontroller.sigstore.dev", Version: "v1beta1", Resource: "clusterimagepolicies"}

var clusterimagepoliciesKind = schema.GroupVersionKind{Group: "policycontroller.sigstore.dev", Version: "v1beta1", Kind: "ClusterImagePolicy"}
