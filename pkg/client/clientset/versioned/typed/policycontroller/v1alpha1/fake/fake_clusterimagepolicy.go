...
type FakeClusterImagePolicies struct {
	Fake *FakePolicycontrollerV1alpha1
}

var clusterimagepoliciesResource = schema.GroupVersionResource{Group: "policycontroller.sigstore.dev", Version: "v1alpha1", Resource: "clusterimagepolicies"}

var clusterimagepoliciesKind = schema.GroupVersionKind{Group: "policycontroller.sigstore.dev", Version: "v1alpha1", Kind: "ClusterImagePolicy"}
