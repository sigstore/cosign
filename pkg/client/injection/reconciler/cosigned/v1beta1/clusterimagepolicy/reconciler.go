...
type reconcilerImpl struct {
	...
	Lister cosignedv1beta1.ClusterImagePolicyLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister cosignedv1beta1.ClusterImagePolicyLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.ClusterImagePolicy) (*v1beta1.ClusterImagePolicy, error) {
	...
	patcher := r.Client.CosignedV1beta1().ClusterImagePolicies()
