...
import (
	...
	clusterimagepolicy "github.com/sigstore/cosign/pkg/client/injection/informers/cosigned/v1alpha1/clusterimagepolicy"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "clusterimagepolicies.cosigned.sigstore.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "cosigned.sigstore.dev.ClusterImagePolicy"),
	)
