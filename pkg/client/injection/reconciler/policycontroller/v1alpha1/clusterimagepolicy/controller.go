...
import (
	...
	clusterimagepolicy "github.com/sigstore/cosign/pkg/client/injection/informers/policycontroller/v1alpha1/clusterimagepolicy"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "clusterimagepolicies.policycontroller.sigstore.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "policycontroller.sigstore.dev.ClusterImagePolicy"),
	)
