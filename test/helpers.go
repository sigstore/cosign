...
var verifyTSA = func(keyRef, imageRef string, checkClaims bool, annotations map[string]interface{}, trustedRootPath string, skipTlogVerify bool) error {
	cmd := cliverify.VerifyCommand{
...
func rekorSigningConfig() *root.SigningConfig {
